...
export const PostBox = () => {
  ...
  return (
    ...
    <div className=' w-[100%] bg-white rounded-lg h-auto p-2 shadow-2xl'>
        ...
        <button className='bg-blue-500 rounded-lg w-[100%] text-white text-base font-bold px-6 py-2 shadow-lg outline-none border-0' onClick={handleCreate} >POST</button>
            </div>
          </div>
        </div>
    </div>
